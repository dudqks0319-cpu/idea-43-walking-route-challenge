...
import 'package:app_43_walking_route_challenge/app.dart';
import 'package:app_43_walking_route_challenge/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('걷기 루트 챌린지'), findsWidgets);
